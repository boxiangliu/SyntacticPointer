...
def train(args):
    ...
    if model_type == 'DeepBiAffine':
        ...
        network = L2RPtrNet(word_dim, num_words, char_dim, num_chars, pos_dim, num_pos, mode, hidden_size,
...
def parse(args):
    ...
    if model_type == 'DeepBiAffine':
        ...
        grandPar = hyps['grandPar']
        sibling = hyps['sibling']
        network = L2RPtrNet(word_dim, num_words, char_dim, num_chars, pos_dim, num_pos,
